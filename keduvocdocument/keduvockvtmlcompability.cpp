...
void KEduVocKvtmlCompability::initOldTypeLists()
{
    ...
    m_oldSubTypeNames.insert(QStringLiteral("ord"),
                             i18nc("@item:inlistbox A subtype of the grammatical word type: Numeral Ordinal  (first, second, third, ...)", "Ordinal"));
    m_oldSubTypeNames.insert(QStringLiteral("crd"),
                             i18nc("@item:inlistbox A subtype of the grammatical word type: Numeral Cardinal (one, two, three, ...)", "Cardinal"));
...
void KEduVocKvtmlCompability::setupWordTypes(KEduVocWordType *parent)
{
    ...
    wordTypeNames << i18nc("The grammatical type of a word", "Verb") // 0
                  << i18nc("The grammatical type of a word", "Noun") // 1
                  << i18nc("The grammatical type of a word", "Name") << i18nc("The grammatical type of a word", "Article") // 3
                  ...
                  << i18nc("The grammatical type of an entry", "Phrase") << i18nc("The grammatical type of a word", "Numeral") // 8
                  << i18nc("The grammatical type of a word", "Conjunction") << i18nc("The grammatical type of a word", "Preposition")
    ...
    KEduVocWordType *wordType =
        new KEduVocWordType(i18nc("@item:inlistbox A subtype of the grammatical word type: Numeral Ordinal  (first, second, third, ...)", "Ordinal"), numeral);
    wordType->setWordType(KEduVocWordFlag::Adjective);
    numeral->appendChildContainer(wordType);
    wordType =
        new KEduVocWordType(i18nc("@item:inlistbox A subtype of the grammatical word type: Numeral Cardinal (one, two, three, ...)", "Cardinal"), numeral);
