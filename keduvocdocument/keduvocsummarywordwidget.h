 ...
 *                                                                         *
 ***************************************************************************/
#ifndef KEDUVOCSUMMARYWORDWIDGET_H
#define KEDUVOCSUMMARYWORDWIDGET_H
...
*       the lesson
        ...
        comment
*/
class KEDUVOCDOCUMENT_EXPORT KEduVocSummaryWordWidget : public QWidget
{
    Q_OBJECT

public:
    KEduVocSummaryWordWidget( KEduVocVocabularyFilter *model, KEduVocDocument *doc, QWidget *parent = 0 );
    ~KEduVocSummaryWordWidget();
...
class KEduVocSummaryWordDelegate : public QItemDelegate
{
    Q_OBJECT
public:
    KEduVocSummaryWordDelegate( QObject *parent = 0 );
